...
img_path= "C:\\Users\\Eli7_Saxe\\Documents\\DataScience\\Datasets\\Spores\\spore\\spore"
...
class YOLO(object):
    ...
    def generate(self):
        ...
        is_tiny_version = True #num_anchors==6 # default setting
        try:
...
if __name__=="__main__":
    ...
    #print(ObjectsList)
    cv2.imwrite("out_spore_08.jpg", r_image)
